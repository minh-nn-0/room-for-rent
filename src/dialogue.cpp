		...
		beaver::sdlgame& game)
{
	...
	sdl::texture text = beaver::make_text_blended(game._graphics._rdr, *font, dialogue._content.substr(0, dialogue._text_index), game._graphics._draw_color, wraplength);
